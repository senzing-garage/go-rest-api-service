...
LABEL Name="senzing/go-rest-api-service-builder" \
...
ENV REFRESHED_AT=2023-02-22
LABEL Name="senzing/go-rest-api-service" \
      Maintainer="support@senzing.com" \
      Version="0.0.5"

# Copy files from prior step.

COPY --from=go_builder "/output/linux/go-rest-api-service" "/app/go-rest-api-service"
...
WORKDIR /app
ENTRYPOINT ["/app/go-rest-api-service"]
