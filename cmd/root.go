...
const (
	...
	Short                          string = "go-rest-api-service short description"
	Use                            string = "go-rest-api-service"
	Long                           string = `
go-rest-api-service long description.
	`
)
...
func loadConfigurationFile(cobraCommand *cobra.Command) {
	...
	if configuration != "" { // Use configuration file specified as a command line option.
		...
		viper.SetConfigName("go-rest-api-service")
