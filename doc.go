...
More information can be found in the [pkg/github.com/senzing/go-rest-api-service/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing/go-rest-api-service/anotherpackage"
	)
